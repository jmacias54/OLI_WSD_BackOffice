...
/**
 * The persistent class for the oli_mx_n_nota database table.
 * 
 */
...
public class NNota implements Serializable {
	...
	public String getFcTipoNota() {
		return this.fcTipoNota;
	}

	public void setFcTipoNota(String fcTipoNota) {
		this.fcTipoNota = fcTipoNota;
	}
